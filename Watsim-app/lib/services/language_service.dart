...
class LanguageService extends ChangeNotifier {
  ...
  String get referralCode => _isFrench ? 'Code : WATSIM-789' : 'Code: WATSIM-789';
  ...
  String get securitySubtitle => _isFrench ? 'PIN, Biométrie, 2FA' : 'PIN, Biometrics, 2FA';
  String get support => _isFrench ? 'Assistance' : 'Support';
  String get helpSupport =>
      _isFrench ? 'Aide & Assistance' : 'Help & Support';
  ...
  String get signOutConfirmTitle =>
      _isFrench ? 'Se déconnecter' : 'Sign Out';
  String get signOutConfirmBody =>
      _isFrench ? 'Êtes-vous sûr de vouloir vous déconnecter ?' : 'Are you sure you want to sign out?';
  ...
  String get availableCredit => _isFrench ? 'Votre crédit disponible est' : 'Your available credit is';
  String get shopInstallments => _isFrench ? 'Achetez maintenant et payez en plusieurs fois' : 'Shop now and pay in instalments';
  String get aboveLimit => _isFrench ? 'Vous dépassez votre limite de crédit disponible' : 'This is above your available credit limit';
  String get usedPercent => _isFrench ? '% Utilisé' : '% Used';
  String get fcfaRemaining => _isFrench ? 'FCFA restants' : 'FCFA remaining';
  String get repayCredit => _isFrench ? 'Remboursez pour restaurer votre crédit' : 'Repay to restore your credit';
  String get tapShopBnpl => _isFrench ? 'Appuyez pour acheter avec BNPL' : 'Tap to shop on BNPL';
  ...
  String get referSubtitle =>
      _isFrench ? 'Gagnez 2 000 FCFA par parrainage actif'
  ...
  String get noReferralsYet =>
      _isFrench ? 'Aucun parrainage pour l\'instant'
          : 'No referrals yet';
  String get noReferralsBody =>
      _isFrench
  ...
  String get howItWorks =>
      _isFrench ? 'Comment ça marche' : 'How it works';
  String get step1 =>
      _isFrench ? 'Partagez votre code avec vos amis' : 'Share your code with friends';
  String get step2 =>
      _isFrench ? 'Ils s\'inscrivent avec votre code' : 'They sign up using your code';
  String get step3 =>
      _isFrench ? 'Ils effectuent leur premier achat BNPL' : 'They complete their first BNPL purchase';
  String get step4 =>
      _isFrench ? 'Vous gagnez instantanément 2 000 FCFA !' : 'You instantly earn 2,000 FCFA!';
  ...
  String get noRewardsYet =>
      _isFrench ? 'Aucune récompense pour l\'instant'
          : 'No rewards yet';
  ...
  String get cashbackConverted =>
      _isFrench ? 'Cashback converti avec succès !' : 'Cashback converted successfully!';
  String get addedToWallet =>
      _isFrench ? 'ajouté à votre portefeuille Watsim' : 'added to your Watsim wallet';
  ...
  String get withdrawAll =>
      _isFrench ? 'Retirer tout' : 'Withdraw All';
  String get confirmWithdraw =>
      _isFrench ? 'Confirmer le retrait' : 'Confirm Withdrawal';
  String get withdrawSuccess =>
      _isFrench ? 'Retrait initié avec succès !' : 'Withdrawal initiated successfully!';
  ...
  String get invalidAmount =>
      _isFrench ? 'Montant invalide' : 'Invalid amount';
  String get amountExceedsBalance =>
      _isFrench ? 'Le montant dépasse votre solde disponible' : 'Amount exceeds your available balance';
  String get minWithdrawAmount =>
      _isFrench ? 'Le montant minimum est 500 FCFA' : 'Minimum withdrawal is 500 FCFA';
  String get rewardsOnlyNote =>
      _isFrench
  ...
  String get youWillReceive =>
      _isFrench ? 'Vous recevrez' : 'You will receive';
  ...
  String get badgeKYC =>
      _isFrench ? 'KYC vérifié' : 'KYC Verified';
  String get badgeTopSpender =>
      _isFrench ? 'Gros dépensier' : 'Top Spender';
  String get badgeSuperActive =>
      _isFrench ? 'Super actif' : 'Super Active';
  String get badgeVIP => 'VIP';

  // Security screen strings
  String get securityTitle => _isFrench ? 'Sécurité' : 'Security';
  String get accountSecured => _isFrench ? 'Compte Sécurisé' : 'Account Secured';
  String get allSecurityActive => _isFrench ? 'Toutes les mesures de sécurité sont actives.' : 'All security measures are active.';
  String get authentication => _isFrench ? 'AUTHENTIFICATION' : 'AUTHENTICATION';
  String get changePIN => _isFrench ? 'Changer le PIN' : 'Change PIN';
  String get changePINSubtitle => _isFrench ? 'Mettre à jour votre PIN de connexion' : 'Update your login PIN';
  ...
  String get biometricsSubtitle => _isFrench ? 'Empreinte digitale / Face ID' : 'Fingerprint / Face ID';
  String get twoFA => _isFrench ? 'Authentification 2FA' : '2-Factor Authentication';
  String get twoFASubtitle => _isFrench ? 'Code OTP par SMS' : 'OTP code via SMS';
  ...
  String get loginAlertsSubtitle => _isFrench ? 'Recevoir des alertes pour les nouvelles connexions' : 'Get notified on new logins';
  String get transactionAlerts => _isFrench ? 'Alertes de transaction' : 'Transaction Alerts';
  String get transactionAlertsSubtitle => _isFrench ? 'Notifications pour chaque transaction' : 'Notifications for every transaction';
  ...
  String get freezeAccountSubtitle => _isFrench ? 'Suspendre temporairement toutes les transactions' : 'Temporarily suspend all transactions';
  String get frKey => 'FR';
  String get enKey => 'EN';

  // ── Splash screen strings ───────────────────────────────────────────────
  String get loadingUniverse =>
      _isFrench ? 'Chargement de votre univers financier...' : 'Loading your financial universe...';
  ...
  String get onboard1Title =>
      _isFrench ? 'Paiements flexibles,\nVie plus intelligente' : 'Flexible Payments,\nSmarter living';
  ...
  String get onboard2Title =>
      _isFrench ? 'Transférez & payez\nen quelques secondes' : 'Transfer & pay\nin seconds';
  ...
  String get onboard3Title =>
      _isFrench ? 'Gagnez des récompenses\npour chaque action' : 'Earn rewards\nfor every action';
  ...
  String get phoneNumberLabel => _isFrench ? 'NUMÉRO DE TÉLÉPHONE' : 'PHONE NUMBER';
  ...
  String get generalTerms =>
      _isFrench ? 'Conditions Générales d\'Utilisation' : 'General Terms of Use';
  ...
  String get phoneNumberField => _isFrench ? 'NUMÉRO DE TÉLÉPHONE' : 'PHONE NUMBER';
  ...
  String get noAccountYet => _isFrench ? 'Pas encore de compte ?  ' : 'No account yet?  ';
  ...
  String get scanNotRecognised =>
      _isFrench ? 'Non reconnu' : 'Not recognised';
  ...
  String get scanPlaceFinger =>
      _isFrench ? 'Placez votre doigt sur le capteur' : 'Place your finger on the sensor';
  ...
  String get checkBalance =>
      _isFrench ? 'Vérifier solde' : 'Check Balance';
  String get bnplCreditHome => _isFrench ? 'Montant Maximum de cotisation' : 'Maximum Contribution Amount';
  ...
  String get ordersWillAppear =>
      _isFrench ? 'Les commandes que vous passez apparaîtront ici' : 'Orders you place will appear here';
  ...
  String get noOrdersYet => _isFrench ? 'Aucune commande passée' : 'No orders placed yet';
  String get makeDeposit => _isFrench ? 'Faire un dépôt' : 'Make a Deposit';
  String get filterByPeriod => _isFrench ? 'Filtrer par période' : 'Filter by Period';
  String get noDataYet => _isFrench ? 'Aucune donnée' : 'No data yet';
  String get spendingByMonth => _isFrench ? 'Dépenses par mois (milliers FCFA)' : 'Spending by Month (thousands FCFA)';
  String get breakdownByCategory => _isFrench ? 'Répartition par catégorie' : 'Breakdown by Category';
  String get deliveryDetails => _isFrench ? 'Détails de livraison' : 'Delivery Details';
  String get confirmIdentityDelivery => _isFrench ? 'Confirmez votre identité et les infos de livraison' : 'Confirm your identity and delivery info';
  String get numberOfItems => _isFrench ? 'Nombre d\'articles' : 'Number of items';
  String get continueToPIN => _isFrench ? 'Continuer vers la confirmation PIN' : 'Continue to PIN Confirmation';
  String get refundReturnedToWallet => _isFrench ? 'Remboursement retourné au portefeuille' : 'Refund Returned to Wallet';
  String get done => _isFrench ? 'Terminé' : 'Done';
  String get confirmTransfer => _isFrench ? 'Confirmer le transfert' : 'Confirm Transfer';
  ...
  String get transferAccumulatedFunds => _isFrench ? 'Transférer les fonds accumulés' : 'Transfer Accumulated Funds';
  String get transferSubtitle => _isFrench ? 'Transférez les paiements déjà effectués vers une autre commande active.' : 'Move payments already made on this order to another active order.';
  String get noPaymentsMadeYet => _isFrench ? 'Aucun paiement effectué. Payez au moins un versement avant de transférer.' : 'No payments made yet. Make at least one instalment before transferring.';
  String get noOtherActiveOrders => _isFrench ? 'Aucune autre commande active vers laquelle transférer.' : 'No other active orders to transfer to.';
  String get selectDestinationOrder => _isFrench ? 'SÉLECTIONNER LA COMMANDE DE DESTINATION' : 'SELECT DESTINATION ORDER';
  String get withdrawPayment => _isFrench ? 'Retirer le paiement ?' : 'Withdraw Payment?';
  String get confirmWithdrawal => _isFrench ? 'Confirmer le retrait' : 'Confirm Withdrawal';
  String get exchangeProduct => _isFrench ? 'Échanger le produit' : 'Exchange Product';
  String get submitExchangeRequest => _isFrench ? 'Soumettre la demande d\'échange' : 'Submit Exchange Request';
  String get instalmentsCount => _isFrench ? 'Versements payés' : 'Instalments paid';
  String get allInstalmentsComplete => _isFrench ? 'Tous les versements payés — Commande terminée' : 'All instalments paid — Order complete';
  String get confirmDelivery => _isFrench ? 'Confirmer la livraison' : 'Confirm Delivery';
  String get enterPINToConfirm => _isFrench ? 'Entrez votre PIN pour confirmer' : 'Enter your PIN to confirm';
  String get confirmIdentityProceed => _isFrench ? 'Confirmez votre identité pour continuer' : 'Confirm your identity to proceed';
  String get confirmContribution => _isFrench ? 'Confirmer la cotisation' : 'Confirm Contribution';
  String get authoriseDelivery => _isFrench ? 'Autoriser cette livraison' : 'Authorise this delivery';
  String get incorrectPIN => _isFrench ? 'PIN incorrect. Réessayez.' : 'Incorrect PIN. Try again.';
  String get demoPIN => _isFrench ? 'Entrez votre PIN pour confirmer' : 'Enter your PIN to confirm';
  String get myBnplOrders => _isFrench ? 'Mes commandes BNPL' : 'My BNPL Orders';
  ...
  String get notificationsTitle => _isFrench ? 'Notifications' : 'Notifications';
  String get markAllRead => _isFrench ? 'Tout marquer comme lu' : 'Mark all read';
  ...
  String get noNotificationsHere => _isFrench ? 'Aucune notification ici' : 'No notifications here';
  ...
  String get growthThisMonth => _isFrench ? '+2,4% ce mois-ci' : '+2.4% this month';
  String get addMoney => _isFrench ? 'Ajouter de l\'argent' : 'Add Money';
  String get topUpWalletInstantly => _isFrench ? 'Rechargez votre portefeuille instantanément' : 'Top up your wallet instantly';
  ...
  String get noTransactionsYet => _isFrench ? 'Aucune transaction pour l\'instant' : 'No transactions yet';
  String get today => _isFrench ? 'Aujourd\'hui' : 'Today';

  // ── Messaging screen (chat settings / dialogs) ───────────────────────────
  String get allMarkedAsRead => _isFrench ? 'Toutes les conversations marquées comme lues' : 'All conversations marked as read';
  String get markAllAsRead => _isFrench ? 'Tout marquer comme lu' : 'Mark all as read';
  String get settingsMenu => _isFrench ? 'Paramètres' : 'Settings';
  String get newConversation => _isFrench ? 'Nouvelle conversation' : 'New Conversation';
  String get newConversationSub => _isFrench ? 'Démarrez un chat avec un autre utilisateur Watsim.' : 'Start a chat with another Watsim user.';
  String get phoneOrId => _isFrench ? 'Numéro de téléphone ou ID' : 'Phone number or ID';
  String get nameOptional => _isFrench ? 'Nom (optionnel)' : 'Name (optional)';
  String get startChat => _isFrench ? 'Démarrer le chat' : 'Start Chat';
  String get videoCallSoon => _isFrench ? 'Appel vidéo bientôt disponible' : 'Video call coming soon';
  String callingName(String name) => _isFrench ? 'Appel de $name…' : 'Calling $name…';
  String viewProfile(String name) => _isFrench ? 'Profil de $name' : '$name\'s profile';
  String blockedUser(String name) => _isFrench ? '$name bloqué' : '$name blocked';
  String get notificationsMuted => _isFrench ? 'Notifications désactivées' : 'Notifications muted';
  String get clearChat => _isFrench ? 'Effacer le chat' : 'Clear chat';
  String get clearChatContent => _isFrench ? 'Tous les messages de ce chat seront supprimés.' : 'All messages in this chat will be deleted.';
  ...
  String get muteNotifications => _isFrench ? 'Désactiver les notifications' : 'Mute notifications';
  String get chatSettings => _isFrench ? 'Paramètres du chat' : 'Chat Settings';
  String get notificationsSection => _isFrench ? 'Notifications' : 'Notifications';
  String get privacySection2 => _isFrench ? 'Confidentialité' : 'Privacy';
  String get appearanceSection => _isFrench ? 'Apparence' : 'Appearance';
  String get messageNotifications => _isFrench ? 'Notifications de messages' : 'Message Notifications';
  String get messageNotificationsSub => _isFrench ? 'Afficher les alertes pour les nouveaux messages' : 'Show alerts for new messages';
  String get soundLabel => _isFrench ? 'Son' : 'Sound';
  String get soundSub => _isFrench ? 'Jouer un son pour les nouveaux messages' : 'Play sound for new messages';
  String get vibrationLabel => _isFrench ? 'Vibration' : 'Vibration';
  String get vibrationSub => _isFrench ? 'Vibrer pour les nouveaux messages' : 'Vibrate for new messages';
  String get readReceipts => _isFrench ? 'Accusés de lecture' : 'Read Receipts';
  String get readReceiptsSub => _isFrench ? 'Afficher quand les messages sont lus' : 'Show when messages are read';
  String get onlineStatusLabel => _isFrench ? 'Statut en ligne' : 'Online Status';
  String get onlineStatusSub => _isFrench ? 'Afficher quand vous êtes actif' : 'Show when you\'re active';
  String get fontSizeLabel => _isFrench ? 'Taille de police' : 'Font Size';
  String get chatWallpaper => _isFrench ? 'Fond d\'écran du chat' : 'Chat Wallpaper';

  // ── Home screen – contribution limit prompt ──────────────────────────────
  String get activeOrderTitle => _isFrench ? 'Cotisation en cours' : 'Active Contribution';
  ...
  String get viewActiveOrder => _isFrench ? 'Voir ma cotisation' : 'View My Contribution';
  String get gotIt => _isFrench ? 'Compris' : 'Got it';
  String get maxContribTitle => _isFrench ? 'Montant trop élevé' : 'Amount Too High';
  ...
  String get chooseAnotherProduct => _isFrench ? 'Choisir un autre produit' : 'Choose Another Product';
  String get messagesTitle => _isFrench ? 'Messages' : 'Messages';
  String get searchConversations => _isFrench ? 'Rechercher des conversations...' : 'Search conversations...';
  String get noConversationsYet => _isFrench ? 'Aucune conversation' : 'No conversations yet';
  String get online => _isFrench ? 'En ligne' : 'Online';
  String get writeAMessage => _isFrench ? 'Écrire un message...' : 'Write a message...';

  // ── BNPL Simulator screen strings ───────────────────────────────────────
  String get simulateBnplTitle => _isFrench ? 'Simuler une cotisation' : 'Simulate BNPL';
  String get simulateInstalments => _isFrench ? 'Simuler vos versements' : 'Simulate your instalments';
  String get choosePlanBudget => _isFrench ? 'Choisissez le plan adapté à votre budget' : 'Choose the plan that fits your budget';
  String get financingDuration => _isFrench ? 'DURÉE DE FINANCEMENT' : 'FINANCING DURATION';
  String get paymentFrequencyLabel => _isFrench ? 'FRÉQUENCE DE PAIEMENT' : 'PAYMENT FREQUENCY';
  String get instalmentDetails => _isFrench ? 'DÉTAILS DES VERSEMENTS' : 'INSTALMENT DETAILS';
  String get selectFrequencyFirst => _isFrench ? 'Sélectionnez une fréquence de paiement pour voir votre échéancier' : 'Select a payment frequency above to see your instalment schedule';
  String get productPrice => _isFrench ? 'Prix du produit' : 'Product Price';
  String get accountCreationFee => _isFrench ? 'Frais de création de compte' : 'Account creation fee';
  String get deliveryFeeLabel => _isFrench ? 'Frais de livraison' : 'Delivery fee';
  ...
  String get selectFrequencyFirst2 => _isFrench ? 'Sélectionnez d\'abord une fréquence de paiement' : 'Select a payment frequency first';
  String get confirmThisPlan => _isFrench ? 'Confirmer ce plan' : 'Confirm this plan';
  String get confirmYourPlan => _isFrench ? 'Confirmer votre plan' : 'Confirm Your Plan';
  String get reviewBeforeConfirm => _isFrench ? 'Vérifiez les détails avant de confirmer' : 'Review the details before confirming';
  ...
  String get selectFrequency => _isFrench ? 'Sélectionner une fréquence' : 'Select payment frequency';
  ...
  String get fullyPaid => _isFrench ? 'Entièrement payé ! 🎉' : 'Fully Paid! 🎉';
  String get paymentSuccessful => _isFrench ? 'Paiement réussi' : 'Payment Successful';
  String get completedAllPayments => _isFrench ? 'Vous avez complété tous vos paiements.' : 'You\'ve completed all your payments.';
  String get instalmentRecorded => _isFrench ? 'Votre versement a été enregistré.' : 'Your instalment has been recorded.';
  String get paymentSummary => _isFrench ? 'RÉSUMÉ DU PAIEMENT' : 'PAYMENT SUMMARY';
  String get orderLabel => _isFrench ? 'Commande' : 'Order';
  String get productLabel => _isFrench ? 'Produit' : 'Product';
  String get contributionAdded => _isFrench ? 'Cotisation ajoutée' : 'Contribution Added';
  String get accumulatedFunds => _isFrench ? 'Fonds accumulés' : 'Accumulated Funds';
  String get remainingBalance => _isFrench ? 'Solde restant' : 'Remaining Balance';
  String get repaymentProgress => _isFrench ? 'Progression du remboursement' : 'Repayment Progress';
  String get paid2 => _isFrench ? 'Payé' : 'Paid';
  String get leftLabel => _isFrench ? 'Restant' : 'Left';
  String get nextPaymentDue => _isFrench ? 'Prochain paiement dû' : 'Next Payment Due';
  String get overpaymentRefunded => _isFrench ? 'Trop-perçu remboursé' : 'Overpayment Refunded';
  String get returnedToWallet => _isFrench ? 'retourné dans votre portefeuille' : 'returned to your wallet';
  String get backToHome => _isFrench ? 'Retour à l\'accueil' : 'Back to Home';
  String get viewMyOrders => _isFrench ? 'Voir mes commandes' : 'View My Orders';
  String get frequencyLabel => _isFrench ? 'Fréquence' : 'Frequency';
  String get insufficientBalance => _isFrench ? 'Solde insuffisant' : 'Insufficient Balance';
  ...
  String get amountNeededTopUp => _isFrench ? 'Montant à recharger' : 'Amount needed to top up';
  String get topUpWallet => _isFrench ? 'Recharger le portefeuille' : 'Top Up Wallet';
  String get maybeLater => _isFrench ? 'Plus tard' : 'Maybe later';
  String get walletBalance => _isFrench ? 'Solde portefeuille' : 'Wallet balance';
  String get makePayment => _isFrench ? 'Effectuer le paiement' : 'Make Payment';
  String get editPlan => _isFrench ? 'Modifier le plan' : 'Edit Plan';
  String get orderConfirmed => _isFrench ? 'Commande confirmée !' : 'Order Confirmed!';
  ...
  String get orderNumberLabel => _isFrench ? 'Numéro de commande' : 'Order number';
  String get amountLabel => _isFrench ? 'montant' : 'amount';
  String get nextInstalment => _isFrench ? 'Prochain versement' : 'Next instalment';
  String get repaymentTitle => _isFrench ? 'Remboursement' : 'Repayment';
  String get amountDueThisMonth => _isFrench ? 'Montant dû ce mois' : 'Amount due this month';
  String get dueOnOctober25 => _isFrench ? 'Dû le 25 octobre 2024' : 'Due on 25 October 2024';
  String get pendingInstalments => _isFrench ? 'VERSEMENTS EN ATTENTE' : 'PENDING INSTALMENTS';
  String get payAllInstalments => _isFrench ? 'Payer tous les versements — 57 500 FCFA' : 'Pay all instalments — 57,500 FCFA';
  String get partialPayment => _isFrench ? 'Paiement partiel' : 'Partial payment';

  // ── Catalogue screen strings ────────────────────────────────────────────
  String get saveNow => _isFrench ? 'Cotiser maintenant' : 'Save Now';
  String get simulateBnpl => _isFrench ? 'Simuler une cotisation' : 'Simulate BNPL';
  String get freeDelivery => _isFrench ? 'Livraison gratuite incluse' : 'Free delivery included';
  ...
  String get noCancelledOrders => _isFrench ? 'Aucune commande annulée' : 'No cancelled orders';
  String get paymentsMade => _isFrench ? 'paiements effectués' : 'payments made';
  String get enjoyProduct => _isFrench
      ? 'Profitez de'
      : 'Enjoy';
  ...
  String get searchForProduct => _isFrench ? 'Rechercher un produit...' : 'Search for a product...';
  String get noResultsFor => _isFrench ? 'Aucun résultat pour' : 'No results for';
  String get tryDifferentKeyword => _isFrench ? 'Essayez un autre mot-clé' : 'Try a different keyword';
  ...
  String get instalmentSchedule => _isFrench ? 'CALENDRIER DES VERSEMENTS' : 'INSTALMENT SCHEDULE';
  String get productActions => _isFrench ? 'ACTIONS PRODUIT' : 'PRODUCT ACTIONS';
  String get exchangeConfirmed => _isFrench ? 'Échange confirmé !' : 'Exchange Confirmed!';
  String get confirmWithPIN => _isFrench ? 'Confirmer avec PIN' : 'Confirm with PIN';
  ...
  String get deliveryInformation => _isFrench ? 'Informations de livraison' : 'Delivery Information';
  String get confirmDeliveryTitle => _isFrench ? 'Confirmer la livraison' : 'Confirm Delivery';
  ...
  String get confirmDeliveryBtn => _isFrench ? 'Confirmer la livraison' : 'Confirm Delivery';
  String get deliveryReceipt => _isFrench ? 'Reçu de livraison' : 'Delivery Receipt';
  String get totalOrderValue => _isFrench ? 'VALEUR TOTALE DE LA COMMANDE' : 'TOTAL ORDER VALUE';
  String get downloadReceipt => _isFrench ? 'Télécharger le reçu' : 'Download Receipt';
  String get close => _isFrench ? 'Fermer' : 'Close';
  String get amountToTransfer => _isFrench ? 'Montant à transférer' : 'Amount to Transfer';
  String get withdrawalSuccessful => _isFrench ? 'Retrait réussi !' : 'Withdrawal Successful!';
  String get withdrawFunds => _isFrench ? 'Retirer les fonds' : 'Withdraw Funds';
  String get makeAContribution => _isFrench ? 'Faire une cotisation' : 'Make a Contribution';
  String get enterYourContribution => _isFrench ? 'Entrez votre cotisation' : 'Enter your contribution';
  String get youAreContributing => _isFrench ? 'Vous cotisez' : 'You are contributing';
  String get tapToChange => _isFrench ? 'Appuyer pour changer' : 'Tap to change';
  String get tapToUpload => _isFrench ? 'Appuyer pour télécharger ou prendre une photo' : 'Tap to upload or take a photo';
  String get jpgPngMax5MB => _isFrench ? 'JPG, PNG — max 5 Mo' : 'JPG, PNG — max 5 MB';
  String get skipForNow => _isFrench ? 'Ignorer pour l\'instant' : 'Skip for now';
  String get verificationSubmitted => _isFrench ? 'Vérification soumise !' : 'Verification Submitted!';
  ...
  String get goToDashboard => _isFrench ? 'Aller au tableau de bord' : 'Go to Dashboard';

  // ── Deposit screen strings ──────────────────────────────────────────────
  String get fundAccountInstantly => _isFrench ? 'Alimentez votre compte Watsim instantanément.' : 'Fund your Watsim account instantly.';
  String get chooseOperator => _isFrench ? 'CHOISIR UN OPÉRATEUR' : 'CHOOSE AN OPERATOR';
  ...
  String get withdrawToMobileMoney => _isFrench ? 'Transférez vers votre compte mobile money.' : 'Transfer to your mobile money account.';
  String get withdrawalMethod => _isFrench ? 'MÉTHODE DE RETRAIT' : 'WITHDRAWAL METHOD';
  String get amountLabel2 => _isFrench ? 'MONTANT' : 'AMOUNT';
  String get withdrawBtn => _isFrench ? 'Retirer' : 'Withdraw';
  String get transferMoney => _isFrench ? "Transférer de l'argent" : 'Transfer Money';
  String get sendToAnotherWatsim => _isFrench ? 'Envoyer vers un autre compte Watsim.' : 'Send to another Watsim account.';
  String get recipient => _isFrench ? 'DESTINATAIRE' : 'RECIPIENT';
  String get transferAmountLabel => _isFrench ? 'MONTANT DU TRANSFERT' : 'TRANSFER AMOUNT';
  ...
  String get enterFirstContribution => _isFrench ? 'Entrez votre première cotisation' : 'Enter your first contribution';
  String get continueToPINBtn => _isFrench ? 'Continuer vers PIN' : 'Continue to PIN';
  String get incorrectPINTryAgain => _isFrench ? 'PIN incorrect. Réessayez.' : 'Incorrect PIN. Try again.';
  ...
  String get noTickets => _isFrench ? 'Aucun ticket pour l\'instant' : 'No tickets yet';
  ...
  String get operatingHours => _isFrench ? 'Heures d\'ouverture' : 'Operating Hours';
  ...
  String get featureWallet => _isFrench ? 'Portefeuille digital' : 'Digital Wallet';
  String get featureWalletSub => _isFrench
      ? 'Dépôts, retraits et transferts instantanés'
      : 'Instant deposits, withdrawals & transfers';
  String get featureSavings => _isFrench ? 'Épargne & Cotisation' : 'Savings & Contributions';
  ...
  String get privacyPolicy => _isFrench ? 'Politique de confidentialité' : 'Privacy Policy';
  String get termsOfService => _isFrench ? 'Conditions d\'utilisation' : 'Terms of Service';
  String get cookiePolicy => _isFrench ? 'Politique des cookies' : 'Cookie Policy';
  ...
  String get manageContribution => _isFrench ? 'GÉRER LA COTISATION' : 'MANAGE CONTRIBUTION';
  String get transferLabel => _isFrench ? 'Transférer' : 'Transfer';
  String get transferSubLabel => _isFrench ? 'Déplacer vers un autre plan' : 'Move to another plan';
  String get withdrawLabel => _isFrench ? 'Retirer' : 'Withdraw';
  String get withdrawSubLabel => _isFrench ? 'Frais de 30% applicables' : '30% charge applies';
  String get exchangeLabel => _isFrench ? 'Échanger' : 'Exchange';
  String get exchangeSubLabel => _isFrench ? 'Remplacer au même prix' : 'Swap for same price';
  String get deliverLabel => _isFrench ? 'Livrer' : 'Deliver';
  String get deliverSubLabel => _isFrench ? 'Demander la livraison' : 'Request delivery';
  String get accumulatedFundsLabel => _isFrench ? 'Fonds accumulés' : 'Accumulated funds';
  String get serviceFee20 => _isFrench ? 'Frais de service (20%)' : 'Service fee (20%)';
  String get recipientReceives => _isFrench ? 'Le destinataire reçoit' : 'Recipient receives';
  String get transferToWatsim => _isFrench ? 'Transférer vers un portefeuille WatSim' : 'Transfer to WatSim Wallet';
  String get sendAccumulatedFunds => _isFrench ? 'Envoyer les fonds accumulés à un autre utilisateur' : 'Send accumulated funds to another user';
  String get noWatsimAccount => _isFrench ? 'Aucun compte WatSim trouvé' : 'No WatSim Account Found';
  ...
  String get transferSuccessful => _isFrench ? 'Transfert réussi !' : 'Transfer Successful!';
  String get continueLabel2 => _isFrench ? 'Continuer' : 'Continue';
  String get deliveryDetailsReceived => _isFrench ? 'Détails de livraison reçus !' : 'Delivery details received!';
  ...
  String get productDelivered => _isFrench ? 'Produit livré ✓' : 'Product Delivered ✓';
  String get deliveryRequested2 => _isFrench ? 'Livraison demandée — en route !' : 'Delivery Requested — on the way!';
  String get markAsReceived => _isFrench ? 'Marquer comme reçu' : 'Mark as Received';
  String get allInstalmentsPaid => _isFrench ? 'Tous les versements payés !' : 'All instalments paid!';
  String get orderFullySettled => _isFrench ? 'Cette commande est entièrement réglée. Plus rien à payer.' : 'This order is fully settled. Nothing more due.';
  String get pleaseSelectDeliveryTime => _isFrench ? 'Veuillez sélectionner un horaire de livraison' : 'Please select a delivery time';
  String get confirmIdentityDeliveryDetails => _isFrench ? 'Confirmez votre identité et les détails de livraison.' : 'Confirm your identity and delivery details.';
  String get receiptDownloaded => _isFrench ? 'Reçu téléchargé avec succès !' : 'Receipt downloaded successfully!';
  String get contributionAddedFunds => _isFrench ? 'Cotisation ajoutée à vos fonds accumulés.' : 'Contribution added to your accumulated funds.';
  String get thisWillCompleteOrder => _isFrench ? 'Cela va finaliser votre commande !' : 'This will complete your order!';
  String exchangedFor(String name) =>
      _isFrench ? 'Votre produit a été échangé contre $name.' : 'Your product has been exchanged for $name.';
  ...
  String get deliveryRequestedTitle => _isFrench ? 'Livraison demandée' : 'Delivery Requested';
  ...
  String get productDeliveredCelebration => _isFrench ? 'Produit livré ! 🎉' : 'Product Delivered! 🎉';
  String instalmentCount(int index, int total) =>
      _isFrench ? 'Versement $index/$total' : 'Instalment $index/$total';
  String refundedToWallet(String amount) =>
      _isFrench ? '$amount remboursé dans votre portefeuille.' : '$amount refunded to your wallet.';
  String get officeConfirmation => _isFrench ? 'Confirmation bureau' : 'Office Confirmation';
  String get watsimOfficialInternal => _isFrench ? 'Watsim Officiel — Interne' : 'Watsim Official — Internal';
  String get confirmReceipt2 => _isFrench ? 'Confirmer la réception' : 'Confirm Receipt';
  String get demoSimulateOffice => _isFrench ? 'Démo : Simuler action bureau' : 'Demo: Simulate Office Action';
  String get officeConfirmsReceipt => _isFrench ? 'Le bureau confirme la réception' : 'Office Confirms Receipt';
  String get howPayCashWorks => _isFrench ? 'Comment fonctionne le paiement en espèces' : 'How Pay in Cash works';
  String get insufficientFunds => _isFrench ? 'Fonds insuffisants' : 'Insufficient funds';
