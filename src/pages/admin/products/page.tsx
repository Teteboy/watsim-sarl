...
export default function AdminProductsPage() {
  ...
  return (
    <AdminLayout breadcrumb={['WATSIM', 'Gestion', 'Produits']}>
      ...
      {/* Edit Product Modal */}
      {editProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(8px)' }} onClick={() => setEditProduct(null)}>
