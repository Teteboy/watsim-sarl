...
export default function AdminCashWithdrawalsPage() {
  ...
  return (
    <AdminLayout breadcrumb={['WATSIM', 'Finance', 'Retraits Cash']}>
      ...
      {/* Reject Modal */}
      {showRejectModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(8px)' }} onClick={() => { setShowRejectModal(null); setRejectReason(''); }}>
          <div className="w-full max-w-md rounded-2xl p-6 space-y-4" style={cardStyle} onClick={e => e.stopPropagation()}>
