export default function CtaSection() {
  return (
    <section id="download" className="py-24 relative overflow-hidden" style={{ background: '#050B16' }}>
      {/* Background */}
      <div className="absolute inset-0">
        <img
          src="https://readdy.ai/api/search-image?query=abstract%20golden%20geometric%20pattern%20with%20dark%20navy%20blue%20background%2C%20luxury%20fintech%20brand%20visual%2C%20elegant%20lines%20and%20shapes%2C%20premium%20financial%20technology%20aesthetic%2C%20minimal%20modern%20design%2C%20gold%20and%20dark%20blue%20color%20palette&width=1440&height=600&seq=cta1&orientation=landscape"
          alt=""
          className="w-full h-full object-cover object-top opacity-20"
        />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(5,11,22,0.95) 0%, rgba(10,22,40,0.9) 100%)' }} />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <i className="ri-smartphone-line text-sm" style={{ color: '#D4AF37' }} />
          <span className="text-sm" style={{ color: '#D4AF37', fontFamily: 'Poppins, sans-serif' }}>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6">
          {[
            ...
            <div key={badge.text} className="flex items-center gap-2">
              <i className={`${badge.icon} text-sm`} style={{ color: '#D4AF37' }} />
